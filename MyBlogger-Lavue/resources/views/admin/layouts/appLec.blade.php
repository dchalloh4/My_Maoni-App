            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <router-link to="/admin/lec/dashboard" active-class="active" class="nav-link">
                        ...
                        <li class="nav-item">
                            <router-link to="/admin/lec/class&teachers" active-class="active" class="nav-link">
                        ...
                        <li class="nav-item">
                            <router-link to="/admin/lec/my-class" class="nav-link" active-class="active">
